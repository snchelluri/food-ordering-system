package co.food.ordering.system.order.service.messaging.listener.kafka;

import co.food.ordering.system.order.service.messaging.mapper.OrderMessagingDataMapper;
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            if(OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()){
                ...
                log.info("Processing rejected order for order id: {}, with failure messages: {} ",
                        ...
                        String.join(",", restaurantApprovalResponseAvroModel
                                .getFailureMessages()));
