...
public class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("1a8a9914-c283-11ed-afa1-0242ac120002");
    private final UUID RESTAURANT_ID = UUID.fromString("2e124b9e-c283-11ed-afa1-0242ac120002");
    private final UUID PRODUCT_ID = UUID.fromString("3d9910b6-c283-11ed-afa1-0242ac120002");
    private final UUID ORDER_ID = UUID.fromString("503c22e4-c283-11ed-afa1-0242ac120002");
    ...
    public void testCreateOrderWithWrongProductPrice(){
        ...
        Assertions.assertEquals(orderDomainException.getMessage(),
                "Order item price: 60.00 is not valid for the product " + PRODUCT_ID);
    }
